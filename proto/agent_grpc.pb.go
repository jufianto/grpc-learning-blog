...
const (
	...
	TaskService_ListTask_FullMethodName   = "/TaskService/ListTask"
	TaskService_StatusTask_FullMethodName = "/TaskService/StatusTask"
)
...
type TaskServiceClient interface {
	...
	StatusTask(ctx context.Context, in *TaskStatusRequest, opts ...grpc.CallOption) (*TasksStatusResponse, error)
}
...
func (c *taskServiceClient) StatusTask(ctx context.Context, in *TaskStatusRequest, opts ...grpc.CallOption) (*TasksStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TasksStatusResponse)
	err := c.cc.Invoke(ctx, TaskService_StatusTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	StatusTask(context.Context, *TaskStatusRequest) (*TasksStatusResponse, error)
...
func (UnimplementedTaskServiceServer) ListTask(context.Context, *TaskListRequest) (*TaskListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTask not implemented")
}
func (UnimplementedTaskServiceServer) StatusTask(context.Context, *TaskStatusRequest) (*TasksStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StatusTask not implemented")
}
...
func _TaskService_StatusTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).StatusTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_StatusTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).StatusTask(ctx, req.(*TaskStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StatusTask",
			Handler:    _TaskService_StatusTask_Handler,
		},
	},
